...
class BaseTrainer:
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in pbar:
                ...
                with torch.cuda.amp.autocast(self.amp):
                    ...
                    self.loss, self.loss_items = self.model(batch)  # infer forword and loss
                    if RANK != -1:
    ...
    def check_resume(self, overrides):
        ...
        # resume = 'E:/workspace/pycharm/yolo/ultralytics-main/runs/segment/train30/weights/last.pt'
    ...
    def resume_training(self, ckpt):
        ...
        # ckpt = torch.load('E:/workspace/pycharm/yolo/ultralytics-main/runs/segment/train30/weights/last.pt')
